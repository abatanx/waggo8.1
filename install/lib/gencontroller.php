...
function install_gencontroller($prefix)
{
	...
	$files = [
		...
		[	$dirinfo["inc"]."/{$prefix}XMLController.php"	,	file_xmlcontroller($prefix)		],
		[	$dirinfo["inc"]."/{$prefix}JSONController.php"	,	file_jsoncontroller($prefix)	],
		[	$dirinfo["inc"]."/HTE.php"						,	file_hte()						]
	];
